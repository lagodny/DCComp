...
procedure TStoHtmlHelpViewer.DisplayHelpByContext(const ContextID: THelpContext;
      const HelpFileName: String);
var
  sHelpFile: String;
begin
...
function TStoHtmlHelpViewer.UnderstandsContext(const ContextID: THelpContext;
      const HelpFileName: String): Boolean;
begin
...
function TStoWinHelpTester.CanShowContext(const Context: THelpContext;
                            const FileName: String): Boolean;
begin
  Result := False;
//  Result := IsHlpFile(FileName);
